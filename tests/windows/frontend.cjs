...
class E {
 ...
 setCustomValidity(){} reportValidity(){} setAttribute(){} removeAttribute(){} addEventListener(n,f){this.events[n]=f} append(...x){this.children.push(...x)} replaceChildren(){this.children=[]} focus(){}
}
