I18N.ru = {
  ...
  passkeyNamesNote: "Название нового Passkey передаётся менеджеру паролей при создании. Переименование на сайте меняет только подпись здесь. Оно не меняет VPN-логин и не переименовывает уже сохранённый ключ в Apple Passwords или 1Password.",
