I18N.ru = {
  ...
  existingVpnVerifiedSignIn: "VPN-доступ {username} проверен. Войдите или зарегистрируйтесь ниже, затем подтвердите привязку в течение 15 минут.",
  ...
  inviteSignIn: "Войдите или зарегистрируйте аккаунт ниже, чтобы привязать свой прежний VPN-доступ. Логин, пароль и установленные профили сохранятся.",
  inviteAccept: "Привязать VPN-доступ",
  inviteDismiss: "Закрыть приглашение",
