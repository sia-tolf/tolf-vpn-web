I18N.ru = {
  inviteExistingPasskey: "Войти с существующим Passkey",
  inviteCreatePasskey: "Создать аккаунт и Passkey",
  ...
  existingVpnVerifiedSignIn: "VPN-доступ {username} проверен. Если аккаунта сайта ещё нет, нажмите «Создать аккаунт и Passkey» — устройство предложит сохранить ключ для входа. Если аккаунт уже есть, нажмите «Войти с существующим Passkey». После входа подтвердите привязку. Проверка действует 15 минут.",
  existingVpnOpen: "У меня уже есть VPN-доступ",
  existingVpnHelp: "Введите прежний VPN-логин и пароль. После проверки войдите с Passkey или зарегистрируйтесь и подтвердите привязку. Установленные VPN-профили продолжат работать.",
  ...
  inviteSignIn: "Для привязки нужен аккаунт сайта. Нажмите «Создать аккаунт и Passkey», если его ещё нет, или «Войти с существующим Passkey», если уже зарегистрированы. Затем подтвердите привязку. Прежние VPN-логин, пароль и профили сохранятся.",
