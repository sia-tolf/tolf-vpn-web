I18N.ru = {
  ...
  dpdMedium: "Средняя",
  dpdHigh: "Высокая",
  dpdHelp: "Частота проверки доступности VPN-сервера клиентом Apple. Высокая — более частые проверки. Отключение DPD не предусмотрено.",
  mobikeHelp: "Позволяет сохранять туннель при смене сети или IP-адреса, если сервер поддерживает MOBIKE.",
  connectionSettingsApply: "Изменения вступят в силу после создания и установки обновлённого профиля.",
  ...
  windowsPasswordRotate: "Сменить пароль",
  windowsPasswordCopy: "Скопировать пароль",
  windowsPasswordCopied: "Пароль скопирован",
  windowsPasswordCopyManual: "Выделите и скопируйте пароль из поля.",
  windowsPasswordConfirm: "Сменить пароль для «{name}»? Старый пароль и ссылки настройки перестанут работать. Затем сохраните новый пароль в TOLF VPN на этом компьютере.",
  windowsPasswordChanged: "Пароль изменён. В Windows отключите VPN, откройте TOLF VPN → Настройки → Обновить пароль и вставьте новый пароль.",
  windowsPasswordUncertain: "Не удалось подтвердить смену. Нажмите «Показать пароль», чтобы получить текущий пароль перед следующей попыткой.",
  windowsPasswordHelp: "Пароль относится только к этому компьютеру. В Windows: TOLF VPN → Настройки → Обновить пароль. Показанный пароль скрывается через минуту.",
  ...
  lastPasskeyExplanation: "Нельзя удалить единственный Passkey: он нужен для входа на сайт. Чтобы заменить его, сначала добавьте другой Passkey. Если хотите удалить весь доступ, воспользуйтесь кнопкой «Удалить аккаунт TOLF» — будут удалены аккаунт и все связанные VPN-доступы.",
  ...
  protectedAccountDelete: "Этот административный аккаунт защищён от удаления через сайт. Для удаления всего доступа обратитесь к администратору.",
  inviteRetryAction: "Повторить привязку",
  passkeySignInName: "Название Passkey",
  ...
  existingVpnHelp: "Введите VPN-логин и пароль, затем создайте Passkey для входа на сайт. Если у вас уже есть Passkey для этого сайта, войдите с ним. Проверенный VPN-доступ привяжется автоматически, ваши VPN-настройки сохранятся.",
  ...
  inviteSignIn: "Настройте вход на сайт или войдите с Passkey. VPN-доступ из приглашения привяжется автоматически.",
  inviteAccept: "Привязать VPN-доступ",
  inviteDismiss: "Отменить привязку",
  inviteReady: "Подключаем существующий VPN-доступ к вашему входу на сайт.",
  ...
  routingPolicySave: "Сохранить правила",
  routingPolicyReload: "Загрузить сохранённые",
  routingSignIn: "Для сохранения правил сначала создайте VPN-доступ.",
  routingLoading: "Загружаем правила…",
  routingSaving: "Сохраняем правила…",
  routingUnsaved: "Изменения ещё не сохранены.",
  routingConflict: "Сохранённый список изменился. Загрузите его заново: несохранённые изменения будут заменены.",
  routingAppliedMoscow: "Применено к вашему активному поддерживаемому VPN-подключению через Москву.",
  routingReadyMoscow: "Готово к следующему поддерживаемому VPN-подключению через Москву.",
  routingNotConfigured: "Персональные правила пока не сохранены.",
  routingPending: "Сохранено. Ожидаем применения на VPN-сервере.",
  routingAddressConflict: "Сохранено, но домены разных направлений имеют общий IP-адрес. Для него действует основная маршрутизация.",
  routingNodeUnavailable: "Сохранено. Нет свежего подтверждения от VPN-сервера; доставка повторится автоматически.",
  routingStoredOnly: "Сохранено. Автоматическое применение для этой учётной записи пока не включено.",
  routingDraftOffline: "Не удалось проверить состояние на сервере. Несохранённые изменения оставлены в редакторе.",
  routingLoadFailed: "Не удалось загрузить правила. Нажмите «Загрузить сохранённые».",
  routingSaveFailed: "Не удалось подтвердить сохранение. Изменения оставлены в редакторе; повторите попытку.",
  routingLimit: "Не более 200 доменов на учётную запись.",
  routingRules: "Правила маршрутизации",
  routingRulesHelp: "Выберите сервер выхода для домена и его поддоменов. В поддерживаемых подключениях правила имеют приоритет над Local ID. Текущий режим использует IPv4 и штатный DNS VPN; применение подтверждается ниже.",
  routingExitRiga: "Рига",
  routingExitMoscow: "Москва",
  routingExitUsa: "США",
  routingSitesCount: "Сайтов: {count}",
  routingNoSites: "Сайты не добавлены",
  ...
  routingRemoveDomain: "Удалить {domain}",
  routingDomainInvalid: "Введите корректный домен, например revolut.com.",
  routingDomainDuplicate: "Этот домен уже назначен серверу {server}.",
  routingDomainAdded: "Домен {domain} добавлен.",
  routingDomainRemoved: "Домен {domain} удалён.",
  routingFinishEditing: "Завершите добавление сайта или отмените ввод.",
  dns: "DNS",
  ...
  androidServerSettingsTitle: "Серверные параметры strongSwan",
  androidServerDpd: "DPD — проверка доступности VPN-соединения. Интервал и действие при потере связи задаются на сервере.",
  androidServerMobike: "MOBIKE — поддержка смены сети, например Wi-Fi → мобильная сеть. Используется, если разрешён на сервере и в strongSwan.",
  androidServerSettingsNote: "DPD задаётся на сервере; использование MOBIKE согласуется при подключении. Эти параметры не настраиваются на этой странице. Их текущие значения на выбранном сервере здесь не отображаются.",
