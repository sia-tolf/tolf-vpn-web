I18N.en = {
  ...
  windowsPasswordRotate: "Change password",
  windowsPasswordCopy: "Copy password",
  windowsPasswordCopied: "Password copied",
  windowsPasswordCopyManual: "Select and copy the password from the field.",
  windowsPasswordConfirm: "Change the password for “{name}”? The old password and setup links will stop working. Then save the new password in TOLF VPN on this computer.",
  windowsPasswordChanged: "Password changed. On Windows, disconnect VPN, open TOLF VPN → Settings → Update password and paste the new password.",
  windowsPasswordUncertain: "Could not confirm the change. Use “Show password” to retrieve the current password before trying again.",
  windowsPasswordHelp: "This password belongs only to this computer. On Windows: TOLF VPN → Settings → Update password. The revealed password hides after one minute.",
  ...
  passkeySignInName: "Passkey name",
  ...
  existingVpnHelp: "Enter your VPN username and password, then create a Passkey for website sign-in. If you already have a Passkey for this website, sign in with it. Your verified VPN access will be linked automatically and your VPN settings will be preserved.",
  ...
  routingLoading: "Loading rules…",
  routingSaving: "Saving rules…",
  routingUnsaved: "Changes have not been saved.",
  routingConflict: "The saved list changed. Reload it before editing again; this will replace your unsaved changes.",
  routingAppliedMoscow: "Applied to your active supported Moscow VPN connection.",
  routingReadyMoscow: "Ready for your next supported Moscow VPN connection.",
  routingNotConfigured: "No personal rules saved.",
  routingPending: "Saved. Waiting for the VPN server to apply the rules.",
  routingAddressConflict: "Saved, but domains assigned to different exits share an IP address. Base routing applies to that address.",
  routingNodeUnavailable: "Saved. No fresh confirmation from the VPN server; delivery retries automatically.",
  routingStoredOnly: "Saved. Automatic application is not enabled for this account yet.",
  routingDraftOffline: "Unable to check server status. Your unsaved changes are retained.",
  routingLoadFailed: "Unable to load rules. Click Reload saved rules.",
  routingSaveFailed: "Could not confirm saving. Your changes are retained; try again.",
  routingLimit: "Maximum 200 domains per account.",
  routingRules: "Routing Rules",
  routingRulesHelp: "Choose an exit for a domain and its subdomains. On supported connections, rules take priority over Local ID. The current mode uses IPv4 and the standard VPN DNS; application status is shown below.",
  routingExitRiga: "Riga",
  routingExitMoscow: "Moscow",
  routingExitUsa: "USA",
  routingSitesCount: "{count} sites",
  routingNoSites: "No sites added",
  routingAddSite: "+ Add site",
  routingDomainLabel: "Website or domain",
  routingDomainPlaceholder: "example.com",
  routingSave: "Add",
  routingCancel: "Cancel",
  routingRemoveDomain: "Remove {domain}",
  routingDomainInvalid: "Enter a valid domain, for example revolut.com.",
  routingDomainDuplicate: "This domain is already assigned to {server}.",
  routingDomainAdded: "{domain} added.",
  routingDomainRemoved: "{domain} removed.",
  routingFinishEditing: "Finish adding the website or cancel the entry.",
  dns: "DNS",
