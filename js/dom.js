...
const signedOutRecoveryBox = document.getElementById("signedOutRecoveryBox");
const signedOutRecoveryCode = document.getElementById("signedOutRecoveryCode");
const copySignedOutRecoveryButton = document.getElementById("copySignedOutRecoveryButton");
const savedSignedOutRecoveryButton = document.getElementById("savedSignedOutRecoveryButton");
const signedOutMessage = document.getElementById("signedOutMessage");
const signOutButton = document.getElementById("signOutButton");
const serverSection = document.getElementById("serverSection");
const selectedServerAddress = document.getElementById("selectedServerAddress");
const serverInputs = document.querySelectorAll('input[name="vpnServer"]');
...
const installProfileButton = document.getElementById("installProfileButton");
const rotatePasswordButton = document.getElementById("rotatePasswordButton");
const rotatePasswordNote = document.getElementById("rotatePasswordNote");
...
const generateRecoveryButton = document.getElementById("generateRecoveryButton");
const accountRecoveryBox = document.getElementById("accountRecoveryBox");
const accountRecoveryCode = document.getElementById("accountRecoveryCode");
const copyAccountRecoveryButton = document.getElementById("copyAccountRecoveryButton");
const savedAccountRecoveryButton = document.getElementById("savedAccountRecoveryButton");
...
const moscowAccessLabel = document.getElementById("moscowAccessLabel");
...
const localIdRoutingHint = document.getElementById("localIdRoutingHint");
