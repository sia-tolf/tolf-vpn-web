...
static void Layout() {
    ...
    MoveWindow(technical,Px(24),Px(footer+38),Px(208),Px(32),TRUE);
    MoveWindow(passwordButton,Px(248),Px(footer+38),Px(208),Px(32),TRUE);
    int passwordY=footer+82+(showDetails?112:0);
    MoveWindow(passwordLabel,Px(24),Px(passwordY),Px(432),Px(56),TRUE);
    MoveWindow(passwordEdit,Px(24),Px(passwordY+62),Px(432),Px(30),TRUE);
    MoveWindow(passwordCancel,Px(24),Px(passwordY+106),Px(208),Px(34),TRUE);
    MoveWindow(passwordSave,Px(248),Px(passwordY+106),Px(208),Px(34),TRUE);
