...
static LRESULT CALLBACK Proc(HWND h,UINT m,WPARAM w,LPARAM l){switch(m){
 ...
 status=control(L"STATIC",L"",0,36,218,488,54,0,smallFont);footer=control(L"STATIC",L(L"Built into Windows  •  TOLF VPN 2.4.1",L"Средствами Windows  •  TOLF VPN 2.4.1",L"Windows līdzekļi  •  TOLF VPN 2.4.1"),SS_CENTER,36,276,488,22,0,smallFont);
