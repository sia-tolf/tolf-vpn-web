...
def install(app, context):
    ...
    def capabilities():
        ...
        return {'version': VERSION, 'servers': list(NODES), 'routing': 'sr', 'routingModes': modes, 'routingRevision': ROUTING_REVISION, 'installerVersion': '2.6.0', 'passwordManagement': True}
