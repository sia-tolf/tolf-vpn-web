    ...
    try:
        ...
        for i in range(12):
            try:
                ...
                if data.get('installerVersion')=='2.4.1':
                    print('OK: Native Windows installer 2.4.1 enabled. Test build is unsigned.'); return
